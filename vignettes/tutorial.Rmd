...
```{r data-dist, echo=T, fig.align= "center", out.width="90%", results=T, message=F, warning=F,eval=FALSE}
...
```{r data-dist, echo=F, fig.align= "center", out.width="90%", results=T, message=F, warning=F,eval=FALSE}
...
```{r data-dist, echo=F, fig.align= "center", out.width="90%", results=F, message=F, warning=F,eval=FALSE}
